...
# Object classes
classNames = ['fresh_apple', 'rotten_apple']

# Camera calibration parameters (You need to adjust these based on your camera calibration)
focal_length = 600  # Focal length of your camera in pixels
...
while True:
    ...
    for r in results:
        ...
        for box in boxes:
            ...
            object_distance_cm = ((known_object_width * focal_length) / object_width_pixels) - 5
